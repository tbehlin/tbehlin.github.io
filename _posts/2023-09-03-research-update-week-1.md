...
    I was able to implement this new method, and I have run it over the usual sets of objects without error.![](/assets/img/week1/old_table.png)_Image of the old .FITS file layout_

![image of the new detailed .FITS file layout](/assets/img/week1/detailed_table.png)_Image of the new detailed .FITS file layout_
...
![example contour along a single axis](/assets/img/week1/slices.png)_example contour plot along the x-axis surrounding a specific halo_
